...
void loop() 
{
  ...
  int Value1 = analogRead(NotePin);
  int NoteFromValue = map(Value1, 0, 1023, 24, 108);//???
  
  int Value2 = analogRead(DurationPin);
  int DurationFromValue = map(Value2, 0, 1023, 1, 127);//???
  ...
  // step
  int Channel = 1;
  int Note = NoteFromValue;//50;
  int Velocity = 80;
  int Duration = DurationFromValue;//96;
